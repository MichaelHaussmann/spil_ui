...
def humanReadable(date_time):
    return convertToHumanReadable(datetime.datetime(date_time))
...
def test():
    ...
    print(convertToHumanReadable('2011-12-20 17:04:23.351000'))
    print(convertToHumanReadable(str(datetime.datetime.now())))
